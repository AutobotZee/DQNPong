...
def train(num_episodes):
    ...
    for i_episode in range(num_episodes):
        ...
        plt.show()
#    with open('zee_model.pickle','wb') as z:
#        pickle.dump((policy_net.state_dict(),target_net.state_dict(),T,episode_durations,R,steps_done),z)
              
    print('Complete')
#    with open('zee_model.pickle', 'rb') as f:
#        policy,target,T,episode_durations,R,steps_done = pickle.load(f)
...
with open('Nov29/Nov29cpu_v0.pickle','rb') as f:
  policy,target,T,episode_durations,R,steps_done = pickle.load(f)
policy_net.load_state_dict(policy)
...
#train(1)        
# =============================================================================
# Training done, and play      
# =============================================================================
play(env)

#next_state=torch.rand(5,4,10,10)
...
# =============================================================================
# Save the model, and update parameters
# =============================================================================
#with open('Nov29gpu.pickle', 'wb') as f:
#  pickle.dump((policy_net.state_dict(),target_net.state_dict(),T,episode_durations,R,steps_done),f)
#with open('Nov29gpu.pickle', 'rb') as f:
#  policy,target,T,episode_durations,R,steps_done = pickle.load(f)
#policy_net.load_state_dict(policy)
#target_net.load_state_dict(target)
...
# =============================================================================
# import copy
# policy_cpu=copy.deepcopy(policy_net)
# target_cpu=copy.deepcopy(target_net)
# for p in policy_cpu.parameters():
#   p=p.cpu()
# for p in target_cpu.parameters():
#   p=p.cpu()
# with open('Nov29cpu.pickle', 'wb') as f:
#   pickle.dump((policy_cpu.state_dict(),target_cpu.state_dict(),T,episode_durations,R,steps_done),f)
# 
# =============================================================================
